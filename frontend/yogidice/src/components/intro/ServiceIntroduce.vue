<template>
  <div id="introduce-slide-container">
    <div id="introduce-slide-box">
      <div class="slide-box">
        <div class="text-huge">빅데이터를 통해 <br/> 다양한 게임을 <br/> 만나보세요!</div>
        <div class="text-headline-6 introduce-content">요기다이스는 총 13만개의 <br/> 게임 데이터를 활용하여 <br/> 사용자에게 게임을 추천합니다.</div>
      </div>
      <div class="slide-box">
        <div class="text-huge">나의 보드게임 취향을 <br/> 한눈에 확인하세요!</div>
        <div class="text-headline-6 introduce-content">보드게임의 진행방식, 난이도, <br/> 카테고리 등을 기반으로 분석한 <br/> 사용자의 취향을 제공합니다.</div>
      </div>    
      <div class="slide-box">
        <div class="text-huge">근처 보드게임 카페를 <br/> 확인하세요!</div>
        <div class="text-headline-6 introduce-content">사용자의 위치를 기준으로 주변 <br/> 보드게임 카페 정보를 제공합니다.  <br/><br/> 또한, 사용자가 원하는 게임이 카페에 있는지도 확인이 가능합니다!</div>
      </div>    
      <div class="slide-box">
        <div class="text-huge">언제 어디서든<br/>보드게임을 즐기세요!</div>
        <div class="text-headline-6 introduce-content">보드게임을 진행할 때 필요한 <br/> 선정하기, 벌칙 정하기 등 다양한 <br/> 추가기능을 제공합니다!</div>
      </div>    
    </div>
    <div id="button-box">
  ...
  setup() {
    ...
    onMounted(function() {
      ...
      prevBtn.addEventListener("click",function(){
        if (pageNum > 1) {
          slideContainer.style.transform = `translateX(${(pageNum-1)*(-100)+100}vw)`;
          pageNum -= 1;
          changePagination()
        }
      })
