  ...
  <div class="map-wrap">
    ...
    <div id="search-result-wrap">
      <div @click="showSearchList">
        <div class="arrow-icon material-icons-outlined" style="rotate:90deg;">arrow_back_ios</div>
...
export default {
  ...
  const initMap = function () {
    ...
    function searchPlaces() {
        ...
        ps.keywordSearch( keyword, placesSearchCB, {location:center, sort: kakao.maps.services.SortBy.ACCURACY, size:3} ); 
    }
    ...
    function getListItem(index, places) {
        ...
        itemStr = '<div class="li-container"> <div class="info">' +
