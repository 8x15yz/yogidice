...
<div style="overflow:scroll">
  <div class="plus-backwall">
    ...
    <div class="buttons-area">
      <div class="disagree-button" @click='notChoicePlayGame'>아니요, 선택하지 않고 진행할래요</div>
      <button @click='choicePlayGame' class='button-long-dark init-select-btn text-button'>
        게임을 선택해주세요?
      </button>
    </div>
  </div>
...
export default {
  ...
  setup(){
    ...
    const notChoicePlayGame = function () {
      ...
      contents.body = "게임을 선택하지 않을 경우, 게임별 제공되는 정보를 이용할 수 없고, 취향 분석의 정확도가 낮아질 수 있습니다. 게임 선택 없이 진행하시겠습니까?"
      contents.footer1 = '계속'
      contents.footer2 = '취소'
      store.dispatch("modal/registModal",contents)
      store.dispatch("modal/openModal")
